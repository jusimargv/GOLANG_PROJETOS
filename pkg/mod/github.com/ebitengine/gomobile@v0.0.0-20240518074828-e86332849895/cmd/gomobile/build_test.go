...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/ebitengine/gomobile/example/basic"})
	oldTags := buildTags
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/ebitengine/gomobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
