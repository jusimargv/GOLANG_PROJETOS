...
//
// See http://godoc.org/github.com/ebitengine/gomobile/cmd/gomobile to install gomobile.
//
// Get the network example and use gomobile to build or install it on your device.
//
//	$ go get -d github.com/ebitengine/gomobile/example/network
//	$ gomobile build github.com/ebitengine/gomobile/example/network # will build an APK
//
//	# plug your Android device to your computer or start an Android emulator.
//	# if you have adb installed on your machine, use gomobile install to
//	# build and deploy the APK to an Android target.
//	$ gomobile install github.com/ebitengine/gomobile/example/network
//
...
//
//	$ go install github.com/ebitengine/gomobile/example/network && network
package main
